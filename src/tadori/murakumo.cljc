...
(defn collection
  [name]
  (str "com.etzhayyim.tadori." name))

(def cell-specs {
  :case_intake {:legacy-cell "case-intake"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "case_intake")]
     :required-gates common-gates
     :trigger "manifest cell case_intake"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :tx_trace {:legacy-cell "tx-trace"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "tx_trace")]
     :required-gates common-gates
     :trigger "manifest cell tx_trace"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :address_label {:legacy-cell "address-label"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "address_label")]
     :required-gates common-gates
     :trigger "manifest cell address_label"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :attribution_join {:legacy-cell "attribution-join"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "attribution_join")]
     :required-gates common-gates
     :trigger "manifest cell attribution_join"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :transparent_force_log {:legacy-cell "transparent-force-log"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "transparent_force_log")]
     :required-gates common-gates
     :trigger "manifest cell transparent_force_log"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :silen_tadori_review {:legacy-cell "silen-tadori-review"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "silen_tadori_review")]
     :required-gates common-gates
     :trigger "manifest cell silen_tadori_review"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
